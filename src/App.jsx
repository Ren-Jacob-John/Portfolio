  ...
  return (
    <>
      ...
      <section className="work-section">
        ...
        <div className="reveal">
          ...
          <div className="videos-grid">
            <div
              ...
              style={{ background: "linear-gradient(135deg,#d4a8c7,#b8860b)" }}
            >
              <div className="brand-badge">ZARA</div>
              <div className="thumb-overlay">
                <div className="thumb-play">▶</div>
                <span>View Project</span>
              </div>
              <div className="thumb-label">ZARA</div>
            </div>
            <div
              className="video-thumb"
              style={{ background: "linear-gradient(135deg,#8b4513,#d4a8c7)" }}
            >
              <div className="brand-badge">H&amp;M</div>
              <div className="thumb-overlay">
                <div className="thumb-play">▶</div>
                <span>View Project</span>
              </div>
              <div className="thumb-label">H&amp;M</div>
            </div>
            <div
              className="video-thumb"
              style={{ background: "linear-gradient(135deg,#2c3e50,#8b7355)" }}
            >
              <div className="brand-badge">MANGO</div>
              <div className="thumb-overlay">
                <div className="thumb-play">▶</div>
                <span>View Project</span>
              </div>
              <div className="thumb-label">MANGO</div>
            </div>
            <div
              className="video-thumb"
              style={{ background: "linear-gradient(135deg,#c8a96e,#3d2b1f)" }}
            >
              <div className="brand-badge">ONLY</div>
              <div className="thumb-overlay">
                <div className="thumb-play">▶</div>
                <span>View Project</span>
              </div>
              <div className="thumb-label">ONLY</div>
            </div>
            <div
              className="video-thumb"
              style={{ background: "linear-gradient(135deg,#1a1a2e,#c8a96e)" }}
            >
              <div className="brand-badge">MYNTRA</div>
              <div className="thumb-overlay">
                <div className="thumb-play">▶</div>
                <span>View Project</span>
              </div>
              <div className="thumb-label">MYNTRA</div>
            </div>
            <div
              className="video-thumb"
              style={{ background: "linear-gradient(135deg,#4a1942,#e8d5a3)" }}
            >
              <div className="brand-badge">AJIO</div>
              <div className="thumb-overlay">
                <div className="thumb-play">▶</div>
                <span>View Project</span>
              </div>
              <div className="thumb-label">AJIO</div>
            </div>
          </div>
        </div>
        ...
        {/* Café */}
        <div className="reveal">
          <div className="category-heading">☕ CAFÉ CONTENT</div>
          <div className="videos-grid">
            <div
              className="video-thumb"
              style={{ background: "linear-gradient(135deg,#3d2b1f,#c8a96e)" }}
            >
              <div className="brand-badge">STARBUCKS</div>
              <div className="thumb-overlay">
                <div className="thumb-play">▶</div>
                <span>View Project</span>
              </div>
              <div className="thumb-label">STARBUCKS</div>
            </div>
            <div
              className="video-thumb"
              style={{ background: "linear-gradient(135deg,#7d5a3c,#f5f0e8)" }}
            >
              <div className="brand-badge">CAFÉ LIFE</div>
              <div className="thumb-overlay">
                <div className="thumb-play">▶</div>
                <span>View Project</span>
              </div>
              <div className="thumb-label">CAFÉ LIFE</div>
            </div>
            <div
              className="video-thumb"
              style={{ background: "linear-gradient(135deg,#c8a96e,#2d1b0e)" }}
            >
              <div className="brand-badge">ARTISAN</div>
              <div className="thumb-overlay">
                <div className="thumb-play">▶</div>
                <span>View Project</span>
              </div>
              <div className="thumb-label">ARTISAN CAFÉ</div>
            </div>
            <div
              className="video-thumb"
              style={{ background: "linear-gradient(135deg,#1a0a00,#d4956a)" }}
            >
              <div className="brand-badge">BREW CO.</div>
              <div className="thumb-overlay">
                <div className="thumb-play">▶</div>
                <span>View Project</span>
              </div>
              <div className="thumb-label">BREW CO.</div>
            </div>
          </div>
        </div>
